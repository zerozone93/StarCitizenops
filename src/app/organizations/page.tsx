    ...
    return (
      <AppShell title="Organizations" subtitle="Command structures">
        <section className="rounded-xl border border-amber-300/20 bg-slate-900/60 p-4">
          <h3 className="text-lg font-semibold text-amber-100">Organizations are temporarily unavailable</h3>
          <p className="mt-2 text-sm text-slate-300">
            Organization data cannot be loaded right now because the upstream database is currently unavailable.
          </p>
        </section>
      </AppShell>
    );
